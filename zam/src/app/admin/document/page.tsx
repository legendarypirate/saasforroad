...
export default function DocumentDmsPage() {
  ...
  }, [currentParentId, q, filterType, filterStatus, filterProject, filterExpiring, isFiltering]);

  useEffect(() => {
    document.title = 'Баримт бичиг — DMS';
    loadStats();
  ...
  return (
    <div className="space-y-5 p-4 sm:p-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-foreground">Баримт бичиг</h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Замын компанийн баримтын сан — гэрээ, зураг, зөвшөөрөл, чанар, гүйцэтгэл
          </p>
        </div>
