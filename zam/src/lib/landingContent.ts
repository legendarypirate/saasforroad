...
export const DEFAULT_HERO_SLIDES: HomepageHeroSlide[] = [
  {
    badge: 'ДЭД БҮТЦИЙН ШИЛДЭГ ШИЙДЭЛ',
    title: 'Илүү сайн дизайнаар дамжуулан урт хугацааны үр нөлөө.',
    subtitle:
      'Бид зам, гүүр, дэд бүтцийн төслүүдийг орчин үеийн технологи, нарийвчилсан инженерчлэлээр хэрэгжүүлдэг.',
  },
  {
    badge: 'ИНЖЕНЕРЧЛЭЛИЙН МЭРГЭЖЛЭВЧЛЭН',
    title: 'Чанар, аюулгүй байдал, хугацаанд нь хүргэлт.',
    subtitle: 'Төслийн бүх үе шатанд ил тод удирдлага, бодит цагийн хяналтын систем.',
  },
  {
    badge: 'ТОГТВОРТОЙ ДЭД БҮТЭЦ',
    title: 'Ирээдүйд зориулсан замын шийдлүүд.',
    subtitle: 'Олон улсын стандарт, орон нутгийн нөхцөлд тохирсон инженерийн шийдэл.',
  },
];

export const DEFAULT_AWARDS: HomepageAward[] = [
  { title: 'Хүндэт өргөмжлөл', issuer: 'Зам тээврийн яам болон авто замчдын холбооноос олгосон', year: '2014' },
  { title: 'Батламж', issuer: 'Зам тээврийн яамаас олгосон', year: '2014' },
  { title: 'Оны онцлох байгууллага «Өргөмжлөл»', issuer: 'Зам тээврийн яамаас олгосон', year: '2015' },
  { title: 'Оны онцлох Энтрэпренер байгууллага', issuer: 'Монголын худалдаа аж үйлдвэрийн танхимаас олгосон', year: '2015' },
  { title: '«ГОЛД» гишүүнээр элссэн гэрчилгээ', issuer: 'Монголын худалдаа аж үйлдвэрийн танхимаас олгосон', year: '2010' },
  { title: 'Талархалын гэрчилгээ', issuer: 'Нийгмийн даатгалын газраас олгосон', year: '2012' },
  { title: 'Монгол Улсын Шилдэг Топ-150 Аж Ахуйн нэгж', issuer: 'Монголын худалдаа аж үйлдвэрийн танхимаас олгосон', year: '2013' },
];

export const DEFAULT_PARTNERS: HomepagePartner[] = [
  { name: 'Зам, тээврийн яам' },
  { name: 'Монголын замчдын холбоо' },
  { name: 'МХААТ' },
  { name: 'Төрийн өмчит «Монгол зам» ХХК' },
  { name: 'Нийслэлийн Засаг даргын тамга' },
...
export const DEFAULT_DIRECTOR_PARAGRAPHS = [
  'Авто замын салбарт манай компани хөл тавьснаас хойш олон жилийн хугацаанд Монгол Улсын хөгжил, дэвшилд бодит хувь нэмэр оруулах томоохон авто замын төслүүд дээр ажилласаар ирлээ. Бид авто замын чанарт илүү анхаарч, дэлхийн дэвшилтэт технологийг нэвтрүүлэн хамгийн боломжит богино хугацаанд гүйцэтгэн, захиалагчдад хүргэж байна.',
  'Манай компани нь олон улсын Чанарын удирдлагын тогтолцоо ISO 9001:2016 стандартыг үйл ажиллагаандаа нэвтрүүлэн ажиллаж байна. Түүнчлэн Монгол Улсын авто замын салбарт төлөвлөлт, хэмжилт, гүйцэтгэл, хяналтын үйл ажиллагааг цогц байдлаар амжилттай хэрэгжүүлж байна.',
  'Бид захиалагч бүрд чанарыг амлаж, төлөвлөсөн цаг хугацаанд төслийг гүйцэтгэхдээ байгаль орчинд ээлтэй, нийгэм, эдийн засгийн үр өгөөжөө илүүтэй өгөхөд чиглүүлж, бизнесийн болон нийтийн эрх ашгийг зохистой хослуулан ажиллаж байна.',
  'Бидэнтэй урт хугацаанд хамтран ажиллаж ирсэн захиалагчид, зөвлөхүүд, бизнесийн түншүүддээ компанийн хамт олны өмнөөс талархал илэрхийлье.',
];
