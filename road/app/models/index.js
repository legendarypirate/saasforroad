...
db.equipment_images = require("./equipment_image.model.js")(sequelize, Sequelize);
...
db.personal_notes.belongsTo(db.users, { foreignKey: "user_id", as: "owner" });
db.users.hasMany(db.personal_notes, { foreignKey: "user_id", as: "personal_notes" });
db.personal_notes.hasMany(db.personal_notes, {
  foreignKey: "parent_id",
  as: "children",
});
...
db.equipments.hasMany(db.equipment_images, {
  foreignKey: "equipment_id",
  as: "images",
  onDelete: "CASCADE",
});
db.equipment_images.belongsTo(db.equipments, {
  foreignKey: "equipment_id",
  as: "equipment",
  onDelete: "CASCADE",
});
