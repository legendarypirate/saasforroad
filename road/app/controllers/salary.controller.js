...
const { monthRange } = require("../utils/attendanceCalculator");
const { summarizePeriod } = require("../utils/attendanceCalculator");
const {
...
async function buildMonthlyRows(month, userIds = null) {
  ...
  const rows = users.map((user) => {
    ...
    const breakdown = calculateSalaryBreakdown(user, summary);
