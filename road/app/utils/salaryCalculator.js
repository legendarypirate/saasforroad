 ...
 */
function calculateSalaryBreakdown(user, summary) {
  ...
  const netPay = Math.max(0, grossPay - absentDeduction);
...
<body style="font-family: Arial, sans-serif; color: #333; line-height: 1.6; max-width: 560px;">
  <h2 style="color: #722ed1;">Цалингийн задаргаа</h2>
  <p>Сайн байна уу, <strong>${username}</strong>,</p>
  <p><strong>${month}</strong> сарын цалингийн задаргаа:</p>
  <table style="width:100%; border-collapse: collapse; margin: 16px 0;">
    ...
    <tr><td style="padding:8px; border-bottom:1px solid #eee;">Цагийн хөлс</td><td style="padding:8px; border-bottom:1px solid #eee; text-align:right;">${formatMoney(b.hourlyRate)} ₮</td></tr>
    ...
    <tr style="background:#f9f0ff;"><td style="padding:12px 8px; font-weight:bold;">Нийт олгох</td><td style="padding:12px 8px; text-align:right; font-weight:bold; color:#722ed1;">${formatMoney(b.netPay)} ₮</td></tr>
  </table>
  <p style="font-size:12px; color:#888;">Энэ имэйлийг HR системээс автоматаар илгээсэн.</p>
</body>
</html>`;
}
...
Цагийн хөлс: ${formatMoney(b.hourlyRate)} ₮
...
Нийт олгох: ${formatMoney(b.netPay)} ₮`;
}
